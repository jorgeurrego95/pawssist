  ...
  return (
    <VaultProvider>
      ...
      >
        ...
        <Tabs.Screen name="pets" options={{ title: 'Pets', tabBarIcon: ({ color, focused }) => <Ionicons name={focused ? 'paw' : 'paw-outline'} color={color} size={24} /> }} />
        <Tabs.Screen name="scan" options={{ title: 'Scan', tabBarIcon: ({ color, focused }) => <Ionicons name={focused ? 'scan' : 'scan-outline'} color={color} size={26} /> }} />
        <Tabs.Screen name="vault" options={{ title: 'Vault', tabBarIcon: ({ color, focused }) => <Ionicons name={focused ? 'folder-open' : 'folder-open-outline'} color={color} size={24} /> }} />
